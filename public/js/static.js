...
function lanzarModal(id) {
                                            ...
                                            <div class="form">
                                                <form class="form validated" id="form-consignment-register" name="remesa">
                                                    ...
                                                    <div class="page slide-page active step1">
                                                        ...
                                                        <div class="field">
                                                            <button class="next" onclick="navigateSteps(event, 'step1', 25, 'name', 'phone')">Siguiente</button>
                                                        </div>
                                                    </div>
    ...
    let user_register = `<div id="form-container" class="flexbox modal">
                                <button class="close-modal" onclick="closeModal()"></button>
                                <div class="multistep-form-container">
                                    <h2 id="form-title"></h2>
                                    ...
                                    <div class="form">
                                        <form class="form validated" id="form-user-register" name="contact">
                                            ...
                                            <div class="page slide-page active next1">
                                                ...
                                                <div class="field">
                                                    <button class="next" onclick="navigateSteps(event, 'next1', 25, 'email', 'password')">Siguiente</button>
                                                </div>
                                            </div>
                                            ...
                                            <div class="page next2">
                                                ...
                                                <div class="field btns">
                                                    ...
                                                    <button class="next" onclick="navigateSteps(event, 'next2', 50, 'name', 'dni')">Siguiente</button>
                                                </div>
                                            </div>
                                            ...
                                            <div class="page next3">
                                                ...
                                                <div class="field btns">
                                                    ...
                                                    <button class="next" onclick="navigateSteps(event, 'next3', 75, 'phone', 'address')">Siguiente</button>
                                                </div>
                                            </div>
